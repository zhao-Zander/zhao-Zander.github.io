...
//         return fetch(getCacheBustingUrl(event.request)).then(networkResponse => {
...
//   } else {
//     // If request is not in the whitelist, fetch it directly.
...
//     icon: 'img/icon_wechat.png',
//     badge: 'img/icon_wechat.png'
//   };
//   event.waitUntil(
//     self.registration.showNotification('My Push Notification', options)
//   );
// });
